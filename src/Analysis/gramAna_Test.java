...
public class gramAna_Test {
	public int bracket_left=0;
	public int bracket_right=0;
	public int num_err = 0;
	public String errors="";
	public ArrayList<String> tokenMap = new ArrayList<String>();
	public ArrayList<String> testMap = new ArrayList<String>(
	...
	public String getNextToken (){
		if(index_tokenMap<tokenMap.size()){
			return tokenMap.get(index_tokenMap++);
		}
		return null;
	}	
	/**
	...
	public void error(String errStr){
		num_err++;
		String err=tokenMap.get(index_tokenMap)+"\t"+errStr+"\n";
		errors+=err;
...
//	    }
	...
	public static void main(String[] args) {
		...
		gramAna_Test ga = new gramAna_Test();
